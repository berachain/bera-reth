...
A high-performance Rust execution client for Berachain, built with the Reth SDK (pinned to reth `v2.5.2`).

## Getting Started

### Prerequisites

- Rust 1.95+ (MSRV inherited from reth v2.5.2; current stable works)
