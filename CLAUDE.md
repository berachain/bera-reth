...
**What**: Rust execution client for Berachain using Reth SDK (git tag `v2.5.2` across all reth-* deps; reth node crates are not on crates.io)  
...
├── reth/               # git clone https://github.com/paradigmxyz/reth.git && cd reth && git checkout v2.5.2
