...
./hive -client bera-reth # first builds and caches the client
...
docker save hive/simulators/berachain/berachain-rpc-compat:latest -o ../hive_assets/berachain_berachain_rpc_compat.tar & saving_pids+=( $! )
